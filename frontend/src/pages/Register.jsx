...
const Register = () => {
  ...
  const { register, googleLogin, login } = useAuth(); // Added login function
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If email exists and uses Google, show special message
          ...
          server: (
            <div>
              ...
              <button
                ...
                className="mt-2 text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 underline text-sm"
              >
  ...
  const handleAutoGoogleLogin = () => {
    ...
    const googleLoginBtn = document.querySelector('[data-testid="google-login-button"]');
    if (googleLoginBtn) {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-10">
              ...
              {errors.server && (
                ...
                >
                  ...
                  <div className="text-red-700 dark:text-red-300 text-sm">{errors.server}</div>
                </motion.div>
              )}
